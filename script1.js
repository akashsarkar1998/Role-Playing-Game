...
// Other functions for game logic...
// ...
...
function buyHealth() {
  ...
  function attack() {
    // Logic for attacking the monster...
    // ...
  }
...
function getMonsterAttackValue(level) {
  ...
  // Function to handle dodging the monster's attack
  function dodge() {
  ...
  // Functions for handling the easter egg game
  function pickTwo() {
    pick(2);
  }
